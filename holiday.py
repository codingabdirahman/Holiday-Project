...
pygame.init()
pygame.display.set_caption("Snake Code")
...
while True: 
    ...
    if direction == 'UP': snake_position[1] = snake_position[1] - 10 
    if direction == 'DOWN': snake_position[1] = snake_position[1] + 10 
    if direction == 'LEFT': snake_position[0] = snake_position[0] - 10 
    if direction == "RIGHT": snake_position[0] = snake_position[0] + 10 
